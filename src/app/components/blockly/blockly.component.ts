...
export class BlocklyComponent implements OnInit {
  ...
  public workspace;
  public code;
  public toolbox = `<xml xmlns='http://www.w3.org/1999/xhtml' id='toolbox' style='display: none;'>
    <category name='Mouvements' colour='#a55a5a'>
        <block type='move'>
  ...
  createMoves() {
    Blockly.Blocks['move'] = {
      init: function() {
        ...
        this.setColour(0);
        this.setTooltip('Fait avancer le personnage d\'un pas.');
        this.setHelpUrl('insert help url');
      }
    };
    ...
    Blockly.Blocks['run'] = {
      init: function() {
        ...
        this.setNextStatement(true, null);
        this.setColour(70);
        this.setTooltip('Fait courir le personnage sur une courte distance.');
        this.setHelpUrl('insert help url');
      }
    };
    ...
    Blockly.Blocks['stop'] = {
      init: function() {
        ...
        this.setNextStatement(true, null);
        this.setColour(200);
        this.setTooltip('Stop le personnage');
        this.setHelpUrl('Add help url here');
      }
    };
    ...
    Blockly.Blocks['jump'] = {
      init: function() {
        this.appendDummyInput()
          .appendField(new Blockly.FieldLabel('Sauter'));
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(300);
        this.setTooltip('La personnage saute');
        this.setHelpUrl('Add help url here');
      }
    };
    ...
    Blockly.Blocks['up'] = {
      init: function() {
        this.appendDummyInput()
          .appendField(new Blockly.FieldLabel('Monter'));
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(99);
        this.setTooltip('Le personnage monte une échelle.');
        this.setHelpUrl('Add help url here');
      }
    };
    ...
    Blockly.Blocks['down'] = {
      init: function() {
        this.appendDummyInput()
          .appendField(new Blockly.FieldLabel('Descendre'));
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(100);
        this.setTooltip('Le personnage descend une échelle.');
        this.setHelpUrl('Add help url here');
      }
    };
    ...
    Blockly.Blocks['pick'] = {
      init: function() {
        this.appendDummyInput()
          .appendField(new Blockly.FieldLabel('Ramasser'));
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(100);
        this.setTooltip('Le personnage ramasse un objet.');
        this.setHelpUrl('Add help url here');
      }
    };
